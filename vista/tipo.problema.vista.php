...
$TITULO_PAGINA = "Gestión de Tipo de Problemas";
...
<html leng="es">
    ...
    <body class="no-skin">
                                  ...
                                  <tbody>
                                      {{#this}}
                                        <tr>
                                            ...
                                            <td>{{peso}}</td>
                                            <td>
                                                <button class="btn btn-xs btn-warning" onclick ="app.editar({{cod_tipo_problema}})" data-toggle="modal" data-target="#mdlRegistro">
                                                <i class="fa fa-edit bigger-130"></i>
                                                </button>
                                                <button class="btn btn-xs btn-danger" onclick ="app.eliminar({{cod_tipo_problema}})">
                        ...
                        <div class="row">
                              ...
                              <div class="col-xs-5">
                                <div class="control-group">
                                  ...
                                  <select name="cbopeso" id="cbopeso" class="form-control" required="">    
        ...
        <script src="js/tipo.problema.vista.js"></script>
    </body>
