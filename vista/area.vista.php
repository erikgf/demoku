...
$TITULO_PAGINA = "Gestión de Áreas";
$CLASE  = "ÁREA";
?>
...
<html leng="es">
    ...
    <body class="no-skin">
                                  ...
                                  <tbody>
                                      {{#this}}
                                        <tr>
                                            ...
                                            <td>{{peso}}</td>
                                            <td>
                                                <button class="btn btn-xs btn-warning" onclick ="app.editar({{cod_area}})" data-toggle="modal" data-target="#mdlRegistro">
                                                <i class="fa fa-edit bigger-130"></i>
                                                </button>
                                                <button class="btn btn-xs btn-danger" onclick ="app.eliminar({{cod_area}})">
                              ...
                              <div class="col-xs-4">
                                <div class="control-group">
                                  ...
                                  <select name="cbopeso" id="cbopeso" class="form-control" required="">
                                    <script id="tpl8Pesos" type="handlebars-x">
        ...
        <script src="js/area.vista.js"></script>
    </body>
